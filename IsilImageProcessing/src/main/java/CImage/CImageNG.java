...
public class CImageNG extends CImage {
    ...
    private void verifieNG(int val) throws CImageNGException {
        if (val < 0 || val > 255) throw new CImageNGException("Valeur du niveau de gris invalide (" + val + ")");
    }
    ...
    public CImageRGB getCImageRGB() {
        ...
        catch (CImageNGException | CImageRGBException ex) { System.err.println("Erreur interne inexpliquee..."); }
        return null;
    }
}
