        ...
        for(int i=0 ; i<largeur ; i++)
            for(int j=0 ; j<hauteur ; j++) {
                if (red[i][j] < 0 || red[i][j] > 255)
                    throw new CImageRGBException("Valeur(s) rouges invalide(s) dans matrices RGB (red[" + i + "][" + j + "] = " + red[i][j] + ")");
                if (green[i][j] < 0 || green[i][j] > 255)
                    throw new CImageRGBException("Valeur(s) vertes invalide(s) dans matrices RGB (green[" + i + "][" + j + "] = " + green[i][j] + ")");
                if (blue[i][j] < 0 || blue[i][j] > 255)
                    throw new CImageRGBException("Valeur(s) bleus invalide(s) dans matrices RGB (blue[" + i + "][" + j + "] = " + blue[i][j] + ")");
